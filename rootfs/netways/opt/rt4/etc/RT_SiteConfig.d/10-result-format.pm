...
Set($UserSearchResultFormat,
  ' \'<a href="__WebPath__/User/Summary.html?id=__id__">__id__</a>/TITLE:#\',\'<a href="__WebPath__/User/Summary.html?id=__id__">__Name__</a>/TITLE:Name\',__RealName__, __EmailAddress__, __CustomField.{Department}__');
